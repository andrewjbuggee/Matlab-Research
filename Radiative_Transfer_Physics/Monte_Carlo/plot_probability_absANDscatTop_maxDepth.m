...
if inputs.N_layers==1
    ...
    if isfield(inputs, 'solar_zenith_angle')==true && isfield(inputs, 'tau_y_upper_limit')==true

        % then this is the 2D or 3D monte carlo code
    ...
    elseif isfield(inputs, 'solar_zenith_angle')==false && isfield(inputs, 'tau_upper_limit')==true

        % then this is the two stream monte carlo method
...
elseif inputs.N_layers>1 && unique(inputs.layerRadii)>1
    ...
    elseif isfield(inputs, 'solar_zenith_angle')==false && isfield(inputs, 'tau_upper_limit')==true
        ...
        % then this is the two stream monte carlo code
