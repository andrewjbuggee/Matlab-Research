...
%% Load coastal data
%coast = load('coast.mat');         Does this file exist?
...
%val = ltln2val(Z, R, lat, lon);            % ltln2val is an old function that won't be supported in new versions
val = geointerp(Z, R, lat, lon);            
isOcean = val == 2;
%isLand = ~isOcean;
