...
#SBATCH --qos=normal
#SBATCH --job-name=noACPW_assumed25_hysicsRetrieval_GRC_%A_%a
#SBATCH --output=noACPW_assumed25_hysicsRetrieval_GRC_%A_%a.out
#SBATCH --error=noACPW_assumed25_hysicsRetrieval_GRC_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=13-15       # 3 jobs × 1 files each = 3 files
