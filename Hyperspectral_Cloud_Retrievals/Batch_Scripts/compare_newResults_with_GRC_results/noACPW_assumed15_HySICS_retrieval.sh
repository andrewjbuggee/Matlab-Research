...
#SBATCH --qos=normal
#SBATCH --job-name=noACPW_assumed15_hysicsRetrieval_GRC_%A_%a
#SBATCH --output=noACPW_assumed15_hysicsRetrieval_GRC_%A_%a.out
#SBATCH --error=noACPW_assumed15_hysicsRetrieval_GRC_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=7-9       # 10 jobs × 2 files each = 20 files
