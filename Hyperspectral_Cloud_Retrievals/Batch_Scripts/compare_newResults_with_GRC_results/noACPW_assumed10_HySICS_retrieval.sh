...
#SBATCH --qos=normal
#SBATCH --job-name=noACPW_assumed10_hysicsRetrieval_GRC_%A_%a
#SBATCH --output=noACPW_assumed10_hysicsRetrieval_GRC_%A_%a.out
#SBATCH --error=noACPW_assumed10_hysicsRetrieval_GRC_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=4-6       # 3 jobs × 1 files each = 3 files
...
RETRIEVED_PROFS_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Droplet_profile_retrievals/testGRC_results4/"
# ----------------------------------------------------------
