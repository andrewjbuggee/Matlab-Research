...
#SBATCH --job-name=create_measurements_for_paper2_noOutput_rTop_10_subset_pt3Percent
#SBATCH --output=measurements_for_paper2_rTop_10_subset_pt3Percent.out
#SBATCH --error=create_measurements_for_paper2_noOutput_rTop_10_subset_pt3Percent.err
