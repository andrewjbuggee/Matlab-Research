...
# In the directory below, there are 24 files
# With 12 jobs and 24 files, each job will process 2 file
...
#SBATCH --qos=normal
#SBATCH --job-name=noACPW_assumed25_retrieval_hysics_rTop_10_test_%A_%a
#SBATCH --output=noACPW_assumed25_retrieval_hysics_rTop_10_test_%A_%a.out
#SBATCH --error=noACPW_assumed25_retrieval_hysics_rTop_10_test_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=5-5       # 1 jobs ×  1 file each = 1 files
...
INPUT_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Simulated_spectra/paper2_variableSweep/rTop_10/test_folder_mimic_localMachine_results"
# ----------------------------------------------------------

# ----------------------------------------------------------
# *** MODIFY THIS DIRECTORY BASED ON THE DESIRED LOCATION ***
# *** MUST HAVE TRAILING SLASH '/' AT THE END         ***
RETRIEVED_PROFS_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Droplet_profile_retrievals/paper2_variableSweep/rTop_10/test_folder_mimic_localMachine_results/"
# ----------------------------------------------------------

# Get list of all files
mapfile -t ALL_FILES < <(find "${INPUT_DIR}" -maxdepth 1 -name "simulated_HySICS_reflectance_35bands*.mat" -type f -printf "%f\n" | sort)
