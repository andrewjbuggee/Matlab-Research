...
#SBATCH --mem=32G
#SBATCH --time=2:30:00     # Longer time for multiple files
#SBATCH --partition=amilan
#SBATCH --qos=normal
#SBATCH --job-name=noACPW_assumed10_retrieval_hysics_rTop_20_subset_%A_%a
#SBATCH --output=noACPW_assumed10_retrieval_hysics_rTop_20_subset_%A_%a.out
#SBATCH --error=noACPW_assumed10_retrieval_hysics_rTop_20_subset_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=37-48       # 12 jobs × 2 file each = 24 files
