...
#SBATCH --qos=normal
#SBATCH --job-name=noACPW_assumed20_retrieval_hysics_rTop_20_subset_%A_%a
#SBATCH --output=noACPW_assumed20_retrieval_hysics_rTop_20_subset_%A_%a.out
#SBATCH --error=noACPW_assumed20_retrieval_hysics_rTop_20_subset_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=13-18       # 6 jobs × 2 files each = 12 files
...
RETRIEVED_PROFS_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Droplet_profile_retrievals/paper2_variableSweep/rTop_10/vza_4_vaz_257_sza_31_saz_96_subset_newRetrieval/"
# ----------------------------------------------------------
