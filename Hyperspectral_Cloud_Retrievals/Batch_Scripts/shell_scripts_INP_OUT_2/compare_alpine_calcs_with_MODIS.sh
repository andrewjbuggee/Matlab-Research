...
#SBATCH --mem=45G
#SBATCH --time=8:00:00     # Longer time for multiple files
#SBATCH --partition=amilan
#SBATCH --qos=normal
#SBATCH --job-name=compare_alpine_calcs_with_MODIS
#SBATCH --output=compare_alpine_calcs_with_MODIS.out
#SBATCH --error=compare_alpine_calcs_with_MODIS.err
...
time matlab -nodesktop -nodisplay -r "addpath(genpath('/projects/anbu8374/Matlab-Research')); addpath(genpath('/scratch/alpine/anbu8374/HySICS/INP_OUT/')); addpath(genpath('/scratch/alpine/anbu8374/Mie_Calculations/')); modis_reflectance_versus_modeled_ensemble_statistics; exit"
