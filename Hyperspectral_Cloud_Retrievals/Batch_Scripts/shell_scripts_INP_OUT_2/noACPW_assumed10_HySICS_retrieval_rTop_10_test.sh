...
#SBATCH --qos=normal
#SBATCH --job-name=noACPW_assumed10_retrieval_hysics_rTop_10_test_%A_%a
#SBATCH --output=noACPW_assumed10_retrieval_hysics_rTop_10_test_%A_%a.out
#SBATCH --error=noACPW_assumed10_retrieval_hysics_rTop_10_test_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=2-2       # 1 jobs ×  1 file each = 1 files
