...
#SBATCH --qos=normal
#SBATCH --job-name=full_retrieval_hysics_rTop_10_lowUncert_test_%A_%a
#SBATCH --output=full_retrieval_hysics_rTop_10_lowUncert_test_%A_%a.out
#SBATCH --error=full_retrieval_hysics_rTop_10_lowUncert_test_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=1-1       # 1 jobs × 1 file each = 1 files
