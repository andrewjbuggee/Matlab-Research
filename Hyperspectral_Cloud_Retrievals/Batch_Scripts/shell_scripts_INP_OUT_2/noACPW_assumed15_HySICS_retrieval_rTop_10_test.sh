...
#SBATCH --qos=normal
#SBATCH --job-name=noACPW_assumed15_retrieval_hysics_rTop_10_test_%A_%a
#SBATCH --output=noACPW_assumed15_retrieval_hysics_rTop_10_test_%A_%a.out
#SBATCH --error=noACPW_assumed15_retrieval_hysics_rTop_10_test_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=3-3       # 1 jobs ×  1 file each = 1 files
