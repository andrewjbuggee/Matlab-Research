%% Generate measurement that mimic those used for GRC with no uncertainty, 0.3% uncertainty and 1% uncertainty
    ...
    for nn = 1:(num_INP_files/num_wl)
        ...
        if inputs.RT.modify_total_columnWaterVapor==true
            ...
            filename = [inputs.folderpath_2save,'simulated_spectra_HySICS_reflectance_',...
                num2str(numel(inputs.bands2run)), 'bands',...
                '_rTop_', num2str(changing_variables(1,1)),...
                '_rBot_', num2str(changing_variables(1,2)),...
                '_tauC_', num2str(changing_variables(1,3)),...
                '_tcwv_', num2str(changing_variables(1,4)),...
                '_vza_', num2str(round(inputs.RT.vza)),...
                '_vaz_', num2str(round(inputs.RT.vaz)),...
                '_sza_', num2str(round(inputs.RT.sza)),...
