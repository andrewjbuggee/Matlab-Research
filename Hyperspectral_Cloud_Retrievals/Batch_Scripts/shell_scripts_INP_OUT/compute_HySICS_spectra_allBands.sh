...
#SBATCH --qos=mem
#SBATCH --ntasks=30
#SBATCH --job-name=compute_hysics_spectra_allBands
#SBATCH --output=hysics_spectra_allBands.out
...
time matlab -nodesktop -nodisplay -r "addpath(genpath('/projects/anbu8374/Matlab-Research')); addpath(genpath('/scratch/alpine/anbu8374/HySICS/INP_OUT/')); addpath(genpath('/scratch/alpine/anbu8374/Mie_Calculations/')); simulate_HySICS_reflectance_slurm; exit"
