...
#SBATCH --qos=normal
#SBATCH --job-name=noACPW_assumed15_retrieval_hysics_rTop_10_subset_5percent_%A_%a
#SBATCH --output=noACPW_assumed15_retrieval_hysics_rTop_10_subset_5percent_%A_%a.out
#SBATCH --error=noACPW_assumed15_retrieval_hysics_rTop_10_subset_5percent_%A_%a.err
