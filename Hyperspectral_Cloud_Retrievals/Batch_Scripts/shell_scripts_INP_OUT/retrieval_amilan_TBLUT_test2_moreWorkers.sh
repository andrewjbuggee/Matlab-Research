...
#SBATCH --mem=100G
#SBATCH --ntasks=25
#SBATCH --job-name=test_retrieval_HySICS_rTop_10_rBot_5_tauC_11_tcwv_14_vza_7_folder1_TBLUT_moreWorkers
#SBATCH --output=test_retrieval_HySICS_rTop_10_rBot_5_tauC_11_tcwv_14_vza_7_folder1_TBLUT_moreWorkers.out
