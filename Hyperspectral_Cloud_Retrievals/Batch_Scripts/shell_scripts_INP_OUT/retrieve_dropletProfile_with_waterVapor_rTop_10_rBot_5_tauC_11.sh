...
#SBATCH --mem=16G
#SBATCH --ntasks=10
#SBATCH --job-name=retrieve_dropletProfile_with_waterVapor_rTop_10_rBot_5_tauC_11
#SBATCH --output=retrieve_dropletProfile_with_waterVapor_for_paper2_rTop_10_rBot_5_tauC_11_test.out
...
time matlab -nodesktop -nodisplay -r "addpath(genpath('/projects/anbu8374/Matlab-Research')); addpath(genpath('/scratch/alpine/anbu8374/HySICS/INP_OUT/')); addpath(genpath('/scratch/alpine/anbu8374/Mie_Calculations/')); retrieve_vertProf_with_H2O_HySICS_rTop_10_rBot_tauC_11; exit"
