...
#SBATCH --job-name=create_measurements_for_paper2_noOutput_rTop_10_subset_1Percent
#SBATCH --output=measurements_for_paper2_rTop_10_subset_1Percent.out
#SBATCH --error=create_measurements_for_paper2_noOutput_rTop_10_subset_1Percent.err
...
time matlab -nodesktop -nodisplay -r "addpath(genpath('/projects/anbu8374/Matlab-Research')); addpath(genpath('/scratch/alpine/anbu8374/HySICS/INP_OUT/')); addpath(genpath('/scratch/alpine/anbu8374/Mie_Calculations/')); clear variables; addLibRadTran_paths; folder_paths = define_folderPaths_for_HySICS(101); folder_paths.HySICS_simulated_spectra = '/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Simulated_spectra/paper2_variableSweep/rTop_10/vza_4_vaz_257_sza_31_saz_96_subset/'; generate_hysics_measurements_noOutput_paper2_rTop_10_1Percent; exit"
