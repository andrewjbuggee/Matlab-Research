...
#SBATCH --mem=16G
#SBATCH --ntasks=10
#SBATCH --job-name=create_measurements_for_paper2_noOutput_rTop_7
#SBATCH --output=measurements_for_paper2_rTop_7_newGeo_rev4.out
...
time matlab -nodesktop -nodisplay -r "addpath(genpath('/projects/anbu8374/Matlab-Research')); addpath(genpath('/scratch/alpine/anbu8374/HySICS/INP_OUT/')); addpath(genpath('/scratch/alpine/anbu8374/Mie_Calculations/')); generate_hysics_measurements_noOutput_paper2_rTop_7; exit"
