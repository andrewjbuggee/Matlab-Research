...
#SBATCH --qos=normal
#SBATCH --job-name=full_retrieval_hysics_rTop_10_subset_5Percent_%A_%a
#SBATCH --output=full_retrieval_hysics_rTop_10_subset_5Percent_%A_%a.out
#SBATCH --error=full_retrieval_hysics_rTop_10_subset_5Percent_%A_%a.err
