...
#SBATCH --mem=15G
#SBATCH --ntasks=9
#SBATCH --job-name=create_measurements_for_paper2_noOutput_rev2
#SBATCH --output=measurements_for_paper2_81stateVectors_noOutput_rev2.out
...
time matlab -nodesktop -nodisplay -r "addpath(genpath('/projects/anbu8374/Matlab-Research')); addpath(genpath('/scratch/alpine/anbu8374/HySICS/INP_OUT/')); addpath(genpath('/scratch/alpine/anbu8374/Mie_Calculations/')); generate_many_measurements_noOutput_paper2; exit"
