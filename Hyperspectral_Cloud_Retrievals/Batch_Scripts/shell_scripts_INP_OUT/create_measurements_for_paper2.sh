...
#SBATCH --mem=20G
#SBATCH --ntasks=11
#SBATCH --job-name=create_measurements_for_paper2_rev1
#SBATCH --output=measurements_for_paper2_81stateVectors.out
...
time matlab -nodesktop -nodisplay -r "addpath(genpath('/projects/anbu8374/Matlab-Research')); addpath(genpath('/scratch/alpine/anbu8374/HySICS/INP_OUT/')); addpath(genpath('/scratch/alpine/anbu8374/Mie_Calculations/')); generate_many_measurements_paper2; exit"
