...
# In the directory below, there are 244 files
# With 61 jobs and 244 files, each job will process 4 files
...
#SBATCH --qos=normal
#SBATCH --job-name=full_retrieval_hysics_rTop_10_remaining_%A_%a
#SBATCH --output=full_retrieval_hysics_rTop_10_remaining_%A_%a.out
#SBATCH --error=full_retrieval_hysics_rTop_10_remaining_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=1-61        # 61 jobs × 4 files each = 244 files
...
INPUT_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Simulated_spectra/paper2_variableSweep/rTop_10/vza_7_vaz_210_sza_10_saz_91_remaining"

RETRIEVED_PROFS_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Droplet_profile_retrievals/paper2_variableSweep/rTop_10/vza_7_vaz_210_sza_10_saz_91/"
