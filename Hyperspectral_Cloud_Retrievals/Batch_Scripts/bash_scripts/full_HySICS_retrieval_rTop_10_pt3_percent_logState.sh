...
#SBATCH --qos=normal
#SBATCH --job-name=full_retrieval_hysics_rTop_10_subset_logState_%A_%a
#SBATCH --output=full_retrieval_hysics_rTop_10_subset_logState_%A_%a.out
#SBATCH --error=full_retrieval_hysics_rTop_10_subset_logState_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=1-10       # 10 jobs × 2 files each = 20 files for subset folder
...
RETRIEVED_PROFS_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Droplet_profile_retrievals/paper2_variableSweep/rTop_10/vza_4_vaz_257_sza_31_saz_96_subset_logState_2/"
# ----------------------------------------------------------
