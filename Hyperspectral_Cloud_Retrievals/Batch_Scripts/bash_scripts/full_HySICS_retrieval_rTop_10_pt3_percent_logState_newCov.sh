...
#SBATCH --array=1-40       # 40 jobs × 21 files each = 840 files for subset folder
...
=======
RETRIEVED_PROFS_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Droplet_profile_retrievals/paper2_variableSweep/rTop_10/vza_4_vaz_257_sza_31_saz_96_subset_logState_newCov3/"
>>>>>>> Stashed changes
# ----------------------------------------------------------
