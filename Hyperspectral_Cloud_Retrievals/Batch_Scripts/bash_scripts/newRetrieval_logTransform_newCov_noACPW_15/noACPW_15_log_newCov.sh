...
#SBATCH --qos=normal
#SBATCH --job-name=noACPW_assumed15_hysicsRetrieval_log_newCov_%A_%a
#SBATCH --output=noACPW_assumed15_hysicsRetrieval_log_newCov_%A_%a.out
#SBATCH --error=noACPW_assumed15_hysicsRetrieval_log_newCov_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=81-120       # 40 jobs × 21 files each = 840 files
...
RETRIEVED_PROFS_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Droplet_profile_retrievals/paper2_variableSweep/newRetrieval_logTransform_newCov_noACPW_15/"
# ----------------------------------------------------------
