...
#SBATCH --job-name=create_meas_pt3_percent_OR_insitu_ERA5_trainingData_sza23
#SBATCH --output=create_meas_pt3_percent_OR_insitu_ERA5_trainingData_sza23_%A_%a.out
#SBATCH --error=create_meas_pt3_percent_OR_insitu_ERA5_trainingData_sza23_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=401-639%15    # 239 measurements from the ensemble_profiles to process
...
# define the offset for the job array so that the measurement index ranges from 1 to 239 instead of 401 to 639
offset=400
