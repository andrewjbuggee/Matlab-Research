...
#SBATCH --array=101-339%15    # throttling to 6 concurrent jobs to avoid overwhelming the filesystem with too many simultaneous MATLAB startups and libRadtran runs
