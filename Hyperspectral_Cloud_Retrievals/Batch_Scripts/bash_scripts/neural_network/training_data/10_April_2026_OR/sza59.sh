...
#SBATCH --job-name=create_meas_pt3_percent_OR_insitu_ERA5_trainingData_sza59
#SBATCH --output=create_meas_pt3_percent_OR_insitu_ERA5_trainingData_sza59_%A_%a.out
#SBATCH --error=create_meas_pt3_percent_OR_insitu_ERA5_trainingData_sza59_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=2001-2237%13    # 237 measurements from the ensemble_profiles to process
...
# define the offset for the job array so that the measurement index ranges from 1 to 239 instead of 2001 to 2239
offset=2000
