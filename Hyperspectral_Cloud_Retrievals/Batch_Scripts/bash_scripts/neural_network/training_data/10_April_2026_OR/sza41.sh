...
#SBATCH --array=1001-1237%13    # 237 measurements from the ensemble_profiles to process
...
# define the offset for the job array so that the measurement index ranges from 1 to 239 instead of 1001 to 1239
offset=1000
