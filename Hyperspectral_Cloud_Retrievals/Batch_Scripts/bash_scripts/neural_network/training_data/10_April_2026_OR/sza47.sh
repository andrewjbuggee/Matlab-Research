...
#SBATCH --job-name=create_meas_pt3_percent_OR_insitu_ERA5_trainingData_sza47
#SBATCH --output=create_meas_pt3_percent_OR_insitu_ERA5_trainingData_sza47_%A_%a.out
#SBATCH --error=create_meas_pt3_percent_OR_insitu_ERA5_trainingData_sza47_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=1301-1537%13    # 237 measurements from the ensemble_profiles to process
...
# define the offset for the job array so that the measurement index ranges from 1 to 239 instead of 1301 to 1539
offset=1300
