...
#SBATCH --job-name=create_meas_synthetic_NN_trainingData_BATCH_TEST
#SBATCH --output=create_meas_synthetic_NN_trainingData_BATCH_TEST_%A_%a.out
#SBATCH --error=create_meas_synthetic_NN_trainingData_BATCH_TEST_%A_%a.err
