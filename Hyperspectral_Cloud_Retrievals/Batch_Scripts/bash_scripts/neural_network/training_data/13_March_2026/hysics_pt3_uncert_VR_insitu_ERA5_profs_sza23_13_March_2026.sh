...
#SBATCH --nodes=1
#SBATCH --time=23:59:59   # Request 24 hours for longer computation
#SBATCH --partition=amilan
#SBATCH --qos=normal
#SBATCH --mem=75G
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=20
#SBATCH --job-name=create_meas_pt3_percent_VR_insitu_ERA5_trainingData_sza23_more_cpus
#SBATCH --output=create_meas_pt3_percent_VR_insitu_ERA5_trainingData_sza23_more_cpus_%A_%a.out
#SBATCH --error=create_meas_pt3_percent_VR_insitu_ERA5_trainingData_sza23_more_cpus_%A_%a.err
...
output_dir="/scratch/alpine/anbu8374/neural_network_training_data/dataSet_created_on_13_March_2026/"
mkdir -p $output_dir
