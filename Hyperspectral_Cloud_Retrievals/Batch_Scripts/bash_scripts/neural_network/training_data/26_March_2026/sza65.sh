...
#SBATCH --job-name=create_meas_pt3_percent_VR_insitu_ERA5_trainingData_sza65_removeModuleLoading
#SBATCH --output=create_meas_pt3_percent_VR_insitu_ERA5_trainingData_sza65_removeModuleLoading_%A_%a.out
#SBATCH --error=create_meas_pt3_percent_VR_insitu_ERA5_trainingData_sza65_removeModuleLoading_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=801-873    # 73 measurements from the ensemble_profiles to process
