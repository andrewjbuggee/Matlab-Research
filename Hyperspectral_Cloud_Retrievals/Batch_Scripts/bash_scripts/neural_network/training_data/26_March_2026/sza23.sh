...
#SBATCH --job-name=create_meas_pt3_percent_VR_insitu_ERA5_trainingData_sza23_removeModuleLoading
#SBATCH --output=create_meas_pt3_percent_VR_insitu_ERA5_trainingData_sza23_removeModuleLoading_%A_%a.out
#SBATCH --error=create_meas_pt3_percent_VR_insitu_ERA5_trainingData_sza23_removeModuleLoading_%A_%a.err
