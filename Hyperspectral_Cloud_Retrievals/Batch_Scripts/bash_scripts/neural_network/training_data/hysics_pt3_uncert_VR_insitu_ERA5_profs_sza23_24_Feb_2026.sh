...
#SBATCH --nodes=1
#SBATCH --time=72:00:00   # Request 72 hours for longer computation
...
# define the offset for the job array so that the measurement index ranges from 1 to 73 instead of 201 to 273
offset=200
