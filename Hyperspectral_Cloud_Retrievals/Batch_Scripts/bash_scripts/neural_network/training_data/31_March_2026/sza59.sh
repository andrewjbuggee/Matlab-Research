...
#SBATCH --job-name=create_meas_pt3_percent_VR_insitu_ERA5_trainingData_sza59
#SBATCH --output=create_meas_pt3_percent_VR_insitu_ERA5_trainingData_sza59_%A_%a.out
#SBATCH --error=create_meas_pt3_percent_VR_insitu_ERA5_trainingData_sza59_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=701-773%10    # 73 measurements from the ensemble_profiles to process
