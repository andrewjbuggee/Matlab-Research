...
#SBATCH --qos=normal
#SBATCH --job-name=full_retrieval_EMIT_log_newCov_allBands_2024_1_13_T194658_rev_3_%A_%a
#SBATCH --output=full_retrieval_EMIT_log_newCov_allBands_2024_1_13_T194658_rev_3_%A_%a.out
#SBATCH --error=full_retrieval_EMIT_log_newCov_allBands_2024_1_13_T194658_rev_3_%A_%a.err
