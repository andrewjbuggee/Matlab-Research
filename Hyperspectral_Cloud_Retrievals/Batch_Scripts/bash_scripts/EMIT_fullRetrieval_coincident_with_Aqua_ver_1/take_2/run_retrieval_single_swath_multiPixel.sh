...
# 
time matlab -nodesktop -nodisplay -r "addpath(genpath('/projects/anbu8374/Matlab-Research')); addpath(genpath('/scratch/alpine/anbu8374/HySICS/INP_OUT/')); addpath(genpath('/scratch/alpine/anbu8374/Mie_Calculations/')); print_status_updates = true; print_libRadtran_err = true;plot_figures = false; save_figures = false; folder_paths = define_EMIT_dataPath_and_saveFolders(2);retrieve_drop_prof_H2O_EMIT_overlap_Aqua_ver5; exit"
