...
#SBATCH --qos=normal
#SBATCH --job-name=full_retrieval_EMIT_log_newCov_allBands_pix4_rev_2_%A_%a
#SBATCH --output=full_retrieval_EMIT_log_newCov_allBands_pix4_rev_2_%A_%a.out
#SBATCH --error=full_retrieval_EMIT_log_newCov_allBands_pix4_rev_2_%A_%a.err
