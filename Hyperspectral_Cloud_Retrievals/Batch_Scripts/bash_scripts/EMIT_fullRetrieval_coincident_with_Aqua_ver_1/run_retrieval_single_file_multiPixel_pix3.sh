...
#SBATCH --qos=normal
#SBATCH --job-name=full_retrieval_EMIT_log_newCov_allBands_pix3_rev_2_%A_%a
#SBATCH --output=full_retrieval_EMIT_log_newCov_allBands_pix3_rev_2_%A_%a.out
#SBATCH --error=full_retrieval_EMIT_log_newCov_allBands_pix3_rev_2_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=203       # 1 jobs × 1 files each = 1 files for subset folder
...
# 
time matlab -nodesktop -nodisplay -r "addpath(genpath('/projects/anbu8374/Matlab-Research')); addpath(genpath('/scratch/alpine/anbu8374/HySICS/INP_OUT/')); addpath(genpath('/scratch/alpine/anbu8374/Mie_Calculations/')); retrieve_drop_prof_H2O_EMIT_overlap_Aqua_ver5_pix3; exit"
