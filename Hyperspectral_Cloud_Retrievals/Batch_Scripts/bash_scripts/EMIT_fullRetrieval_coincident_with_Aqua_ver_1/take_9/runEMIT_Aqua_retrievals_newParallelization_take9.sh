...
#SBATCH --qos=normal
#SBATCH --job-name=EMIT_dropProf_subdir_10MODISpix_10emitPix_%A_%a
#SBATCH --output=EMIT_dropProf_subdir_10MODISpix_10emitPix_%A_%a.out
#SBATCH --error=EMIT_dropProf_subdir_10MODISpix_10emitPix_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=301-307       # UPDATE: set to the number of subdirectories
