...
#SBATCH --output=compute_mieTable_for_libRadtran_gammaDist_rev3_wavelength_idx_%A_%a.out
#SBATCH --error=compute_mieTable_for_libRadtran_gammaDist_rev3_wavelength_idx_%A_%a.err
