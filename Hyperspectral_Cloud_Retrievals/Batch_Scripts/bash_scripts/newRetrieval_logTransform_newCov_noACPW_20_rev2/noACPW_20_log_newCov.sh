...
# With 60 jobs and 840 files, each job will process 14 files
...
#SBATCH --qos=normal
#SBATCH --job-name=noACPW_assumed20_hysicsRetrieval_log_newCov_%A_%a
#SBATCH --output=noACPW_assumed20_hysicsRetrieval_log_newCov_%A_%a.out
#SBATCH --error=noACPW_assumed20_hysicsRetrieval_log_newCov_%A_%a.err
#SBATCH --mail-user=anbu8374@colorado.edu
#SBATCH --mail-type=ALL
#SBATCH --array=300-360       # 60 jobs × 14 files each = 840 files
...
# Define the directory containing the simulated measurement files
# ----------------------------------------------------------
# *** MODIFY THIS DIRECTORY BASED ON THE LOCATION OF THE MEASUREMENTS ***
# *** CANNOT HAVE TRAILING SLASH '/' AT THE END         ***
INPUT_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Simulated_spectra/paper2_variableSweep/testing_new_log_state_and_prior_cov"
# ----------------------------------------------------------

# --------------------------------------------------------------------------------------------
# *** MODIFY THIS DIRECTORY BASED ON THE DESIRED LOCATION OF THE DROPLET PROFILE RETRIEVALS***
# *** MUST HAVE TRAILING SLASH '/' AT THE END         ***
RETRIEVED_PROFS_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Droplet_profile_retrievals/paper2_variableSweep/newRetrieval_logTransform_newCov_noACPW_20_rev2/"
# ----------------------------------------------------------
