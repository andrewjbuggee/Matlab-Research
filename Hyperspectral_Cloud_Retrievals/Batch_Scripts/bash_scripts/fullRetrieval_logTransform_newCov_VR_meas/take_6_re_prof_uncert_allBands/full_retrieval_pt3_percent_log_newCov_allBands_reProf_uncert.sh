...
INPUT_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Simulated_spectra/paper2_variableSweep/log_newCov_all636Bands_VR_inSitu_3"
# ----------------------------------------------------------

# ----------------------------------------------------------
# *** MODIFY THIS DIRECTORY BASED ON THE DESIRED LOCATION ***
# *** MUST HAVE TRAILING SLASH '/' AT THE END         ***
RETRIEVED_PROFS_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Droplet_profile_retrievals/paper2_variableSweep/full_retrieval_logSpace_newCov_VR_meas_allBands_with_reProf_uncert_2/"
# ----------------------------------------------------------
