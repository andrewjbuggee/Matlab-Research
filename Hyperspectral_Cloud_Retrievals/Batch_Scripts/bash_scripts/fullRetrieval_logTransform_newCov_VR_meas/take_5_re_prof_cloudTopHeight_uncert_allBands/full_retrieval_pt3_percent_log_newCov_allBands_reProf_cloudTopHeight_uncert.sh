...
#SBATCH --qos=normal
#SBATCH --job-name=full_retrieval_hysics_VR_meas_log_newCov_allBands_reProf_cloudTopHeight_uncert_%A_%a
#SBATCH --output=full_retrieval_hysics_VR_meas_log_newCov_allBands_reProf_cloudTopHeight_uncert_%A_%a.out
...
RETRIEVED_PROFS_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Droplet_profile_retrievals/paper2_variableSweep/full_retrieval_logSpace_newCov_VR_meas_allBands_with_reProf_and_cloudTop_uncert_1/"
# ----------------------------------------------------------
