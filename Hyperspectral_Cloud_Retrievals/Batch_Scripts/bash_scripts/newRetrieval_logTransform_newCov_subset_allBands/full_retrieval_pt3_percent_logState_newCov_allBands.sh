...
#SBATCH --qos=normal
#SBATCH --job-name=full_retrieval_hysics_logState_newCov_subset_allBands_%A_%a
#SBATCH --output=full_retrieval_hysics_logState_newCov_subset_allBands_%A_%a.out
...
INPUT_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Simulated_spectra/paper2_variableSweep/newRetrieval_logTransform_newCov_subset_allBands"
# ----------------------------------------------------------

# ----------------------------------------------------------
# *** MODIFY THIS DIRECTORY BASED ON THE DESIRED LOCATION ***
# *** MUST HAVE TRAILING SLASH '/' AT THE END         ***
RETRIEVED_PROFS_DIR="/projects/anbu8374/Matlab-Research/Hyperspectral_Cloud_Retrievals/HySICS/Droplet_profile_retrievals/paper2_variableSweep/newRetrieval_logTransform_newCov_subset_allBands/"
# ----------------------------------------------------------
