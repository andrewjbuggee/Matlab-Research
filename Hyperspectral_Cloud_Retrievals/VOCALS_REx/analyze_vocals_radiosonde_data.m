...
% Plot temperature
subplot(1,3,1)
plot(temperature(:, closestIndex), altitude, 'Color', mySavedColors(61,'fixed'));
...
% Plot pressure
subplot(1,3,2)
plot(pressure(:, closestIndex), altitude,'Color', mySavedColors(62,'fixed'));
...
subplot(1,3,3)
plot(RH(:, closestIndex), altitude, 'Color', mySavedColors(63,'fixed'));
