...
function [GN_inputs] = create_EMIT_measurement_cov_ver4_log_no_FM_uncert(GN_inputs, emit)
...
elseif strcmp(covariance_type,'independent') == true
    ...
    GN_inputs.measurement.uncert_frac = emit.reflectance.uncertainty./emit.reflectance.value;
    reflec_uncert = emit.reflectance.uncertainty;  % 1/sr
    reflec_mean = emit.reflectance.value;           % 1/sr
