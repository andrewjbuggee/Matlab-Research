...
function [input_filename, output_filename, mie_folder] = write_mie_file_differentPath(mie_program, index_refraction,...
...
elseif strcmp(computer_name,'curc')==true
    ...
    mie_folder = '/scratch/alpine/anbu8374/Mie_Calculations_2/';
