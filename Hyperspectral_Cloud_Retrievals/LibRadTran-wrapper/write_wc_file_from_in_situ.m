...
%   (4) inSitu_campaign - string containing the name of the field campaign

%   (5) inSitu_date - a datetime string containing the date of the sampled
%   data

%   (6) inSitu_time - double containing the UTC time of the samples half
%   way though the cloud (in altitude)


%   (7) compute_weighting_functions - a true or false flag that tells the
...
%   (8) computer_name - the computer this code is running on
...
%   (10) wc_folder_path - Used to define where the water cloud wc files are
%   store
