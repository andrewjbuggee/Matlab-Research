...
function [GN_output, GN_inputs] = calc_retrieval_gauss_newton_HySICS_ver4_log_forMo_uncert_3(GN_inputs,...
...
if print_status_updates==true
    ...
    for ii = 1:num_iterations
        ...
        % (2) Cloud top height assumption
        % (3) Droplet distribution effective variance assumption
        jacobian_fm = compute_forMod_jacobian_HySICS_log_reP_CTH_vEff(exp(current_guess), measurement_estimate_ln, GN_inputs,...
            hysics.spec_response.value, jacobian_barPlot_flag, folder_paths);
...
% ** For uncertainty with re profile and cloud top height **
jacobian_fm = compute_forMod_jacobian_HySICS_log_reProf_cloudTopHeight( retrieval(:, end), measurement_estimate_ln, GN_inputs,...
    hysics.spec_response.value, jacobian_barPlot_flag, folder_paths);
