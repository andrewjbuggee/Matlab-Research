...
if print_status_updates == true
    ...
    for ii = 1:num_iterations
        ...
        if ii==1
            ...
            measurement_estimate_ln = log(compute_forward_model_4EMIT_top_bottom_ver2( exp(current_guess),...
                GN_inputs,spec_response.value, folder_paths, radiosonde_datProfiles,...
        ...
        Jacobian = compute_jacobian_4EMIT_top_bottom_ver4_logState( exp(current_guess),...
            measurement_estimate_ln, GN_inputs, spec_response.value,...
            jacobian_barPlot_flag, folder_paths, radiosonde_datProfiles,...
            pixel_num, delete_inp_out);
        ...
        if max_a==0 && current_guess(1)==current_guess(2)
            ...
            new_measurement_estimate = log(compute_forward_model_4EMIT_top_bottom_ver2( exp(current_guess),...
                GN_inputs, spec_response.value, folder_paths, radiosonde_datProfiles, pixel_num, delete_inp_out));
        ...
        elseif max_a==0 && ii>1
            ...
            if ii==1 && a(min_residual_idx)==0 
                ...
                new_measurement_estimate = log(compute_forward_model_4EMIT_top_bottom_ver2( exp(new_guess), GN_inputs,...
                    spec_response.value, folder_paths, radiosonde_datProfiles, pixel_num, delete_inp_out));
    ...
    for ii = 1:num_iterations
        ...
        Jacobian = compute_jacobian_4EMIT_top_bottom_ver4_logState( exp(current_guess), measurement_estimate_ln, GN_inputs, spec_response.value,...
            jacobian_barPlot_flag, folder_paths, radiosonde_datProfiles, pixel_num, delete_inp_out);
