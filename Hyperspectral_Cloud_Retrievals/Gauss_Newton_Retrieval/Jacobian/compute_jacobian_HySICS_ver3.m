...
change_in_state = [0.1 * r_top, 0.1 * r_middle, 0.35 * r_bottom, 0.1 * tau_c, 0.1 * wv_col_aboveCloud];
...
wc_re_top_change = write_wc_file(re_with_topChange, changing_variables(1,4), GN_inputs.RT.z_topBottom,...
    ...
    GN_inputs.compute_weighting_functions, which_computer, 1, 3);

wc_re_middle_change = write_wc_file(re_with_middleChange, changing_variables(num_wl+1,4), GN_inputs.RT.z_topBottom,...
    GN_inputs.RT.lambda_forTau, GN_inputs.RT.distribution_str, GN_inputs.RT.distribution_var,...
    GN_inputs.RT.vert_homogeneous_str, GN_inputs.RT.parameterization_str, GN_inputs.RT.indVar,...
    GN_inputs.compute_weighting_functions, which_computer, 2, 3);

wc_re_bot_change = write_wc_file(re_with_botChange, changing_variables(2*num_wl+1,4), GN_inputs.RT.z_topBottom,...
    GN_inputs.RT.lambda_forTau, GN_inputs.RT.distribution_str, GN_inputs.RT.distribution_var,...
    GN_inputs.RT.vert_homogeneous_str, GN_inputs.RT.parameterization_str, GN_inputs.RT.indVar,...
    GN_inputs.compute_weighting_functions, which_computer, 3, 3);

wc_tau_change = write_wc_file(re_with_noChange, changing_variables(3*num_wl +1,4), GN_inputs.RT.z_topBottom,...
    GN_inputs.RT.lambda_forTau, GN_inputs.RT.distribution_str, GN_inputs.RT.distribution_var,...
    GN_inputs.RT.vert_homogeneous_str, GN_inputs.RT.parameterization_str, GN_inputs.RT.indVar,...
    GN_inputs.compute_weighting_functions, which_computer, 4, 3);

wc_with_no_change = write_wc_file(re_with_noChange, changing_variables(4*num_wl +1,4), GN_inputs.RT.z_topBottom,...
    GN_inputs.RT.lambda_forTau, GN_inputs.RT.distribution_str, GN_inputs.RT.distribution_var,...
    GN_inputs.RT.vert_homogeneous_str, GN_inputs.RT.parameterization_str, GN_inputs.RT.indVar,...
    GN_inputs.compute_weighting_functions, which_computer, 5, 3);
