...
function [GN_inputs] = create_HySICS_measurement_cov_ver4_log_no_FM_uncert(GN_inputs, simulated_measurements)
...
elseif strcmp(covariance_type,'independent') == true
    ...
    GN_inputs.measurement.uncertainty = linspace((measurement_uncertainty_percent)/100,...
        (measurement_uncertainty_percent)/100,...
