...
for ii = 1:num_iterations
    ...
    % constraints: r_middle< (r_top + new_direction) <inf; and
    % 0< (r_bot + new_direction) <r_top; and
    % r_bot< (r_middle + new_direction) <r_top;
    ...
    [max_a, ~] = max(a(constrained_guesses(1,:)>constrained_guesses(2,:) & ...
        ...
        constrained_guesses(1,:)>0 & ...
        constrained_guesses(2,:)<=25 & ...
        constrained_guesses(2,:)>0 & ...
        constrained_guesses(3,:)<=25 & ...
