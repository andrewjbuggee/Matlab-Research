...
% update the total water vapor content
inputs.RT.modify_total_columnWaterVapor = true;
inputs.RT.waterVapor_column = 15;                  % mm
...
inputs.RT.vza = 19;        % degrees - Viewing Zenith Angle
...
num_tcpw = length(inputs.RT.waterVapor_column);
...
inputs.measurement.uncert = 0.001;
...
elseif strcmp(which_computer,'andrewbuggee')==true
    ...
    inputs.folderpath_2save = ['/Users/andrewbuggee/Documents/MATLAB/Matlab-Research/Hyperspectral_Cloud_Retrievals/',...
        'HySICS/Simulated_spectra/paper2_variableSweep/vza_4_vaz_257_sza_31_saz_96_subset/'];
