...
function tblut_retrieval_2 = TBLUT_for_HySICS_smallDrops_smallTau(simulated_measurements, folder_paths, tblut_retrieval_1, print_status_updates, print_libRadtran_err)
