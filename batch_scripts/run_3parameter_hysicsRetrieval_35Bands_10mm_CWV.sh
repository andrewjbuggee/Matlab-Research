...
#SBATCH --mem=100G       
#SBATCH --ntasks=30
#SBATCH --job-name=retrieve_3Parameters_35Bands_10mm_H2O
#SBATCH --output=retrieve_3Parameters_35Bands_10mm_H2O.out
...
time matlab -nodesktop -nodisplay -r "addpath(genpath('/projects/anbu8374/Matlab-Research')); addpath(genpath('/scratch/alpine/anbu8374/HySICS/INP_OUT/')); addpath(genpath('/scratch/alpine/anbu8374/Mie_Calculations/')); hysics_35Bands_10mm_totalCWV; exit"
