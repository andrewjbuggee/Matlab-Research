...
figure1.Position = [1, 1, 2.5*w, 2.5*h];
...
elseif strcmp(whatComputer,'andrewbuggee')==true
    folderpath_figs = '/Users/andrewbuggee/Documents/MATLAB/Matlab-Research/Presentations_and_Papers/PhD_defense/';
end
saveas(figure1,[folderpath_figs,'VOCALS-REx in-situ median profiles of droplet size and LWC',...
    ' with 10 and 90 percentiles.fig']);


% save .png with 500 DPI resolution
% remove title
% title('');
exportgraphics(figure1,[folderpath_figs,'VOCALS-REx in-situ median profiles of droplet size and LWC',...
    ' with 10 and 90 percentiles - function of z.png'],'Resolution', 500);
% -------------------------------------
% -------------------------------------
