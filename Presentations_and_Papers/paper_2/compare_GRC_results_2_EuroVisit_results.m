...
% Using the new measurements and the new a priori values and a priori
% covariance matrix. Now also using the new Jacobian calcualtion that
% should be better at ensuring the change or some small perturbation of
% each state variable is linear!
...
if strcmp(which_computer,'anbu8374')==true
    ...
    % ---- Define where the retrievals are stored ---
    folder_paths.drive = '/Users/anbu8374/MATLAB-Drive/HySICS/Droplet_profile_retrievals/testGRC_results5/';
...
elseif strcmp(which_computer,'andrewbuggee')==true
    ...
    % ---- Define where the retrievals are stored ---
    folder_paths.drive = '/Users/andrewbuggee/MATLAB-Drive/HySICS/Droplet_profile_retrievals/testGRC_results5/';
...
% covariance matrix. Now also using the new Jacobian calcualtion that
% should be better at ensuring the change or some small perturbation of
% each state variable is linear! I've now further reduced the a priori
% uncertainty, but I don't expect this will do anything new becuase this
% should punish solutions even more for deviating away from the a priori
% (or first iteration) value.
...
if strcmp(which_computer,'anbu8374')==true
    ...
    % ---- Define where the retrievals are stored ---
    folder_paths.drive = '/Users/anbu8374/MATLAB-Drive/HySICS/Droplet_profile_retrievals/testGRC_results6/';
...
elseif strcmp(which_computer,'andrewbuggee')==true
    ...
    % ---- Define where the retrievals are stored ---
    folder_paths.drive = '/Users/andrewbuggee/MATLAB-Drive/HySICS/Droplet_profile_retrievals/testGRC_results6/';
...
% (1) the new a priori values for the radius at cloud top and bottom
% (2) the original a priori unceratinty and covariance matrix
...
% state vector of 5 instead of 20
...
if strcmp(which_computer,'anbu8374')==true
    ...
    % ---- Define where the retrievals are stored ---
    folder_paths.drive = '/Users/anbu8374/MATLAB-Drive/HySICS/Droplet_profile_retrievals/testGRC_results7/';
...
elseif strcmp(which_computer,'andrewbuggee')==true
    ...
    % ---- Define where the retrievals are stored ---
    folder_paths.drive = '/Users/andrewbuggee/MATLAB-Drive/HySICS/Droplet_profile_retrievals/testGRC_results7/';
...
if strcmp(which_computer,'anbu8374')==true
    ...
    % ---- Define where the retrievals are stored ---
    folder_paths.drive = '/Users/anbu8374/MATLAB-Drive/HySICS/Droplet_profile_retrievals/testGRC_results8/';
...
elseif strcmp(which_computer,'andrewbuggee')==true
    ...
    % ---- Define where the retrievals are stored ---
    folder_paths.drive = '/Users/andrewbuggee/MATLAB-Drive/HySICS/Droplet_profile_retrievals/testGRC_results8/';
